...
char1 = arcade.load_texture("C-2.png")
char2 = arcade.load_texture("C-1.jpg")
back = arcade.load_texture("3.jpg")
...
class Game(arcade.View):
    ...
    def on_draw(self):
        arcade.start_render()
        if self.state == "GameMenu":
            arcade.draw_text("Welcome to Wandering in the woods game", 100, 300, arcade.color.WHITE, font_size=28)
            arcade.draw_text("Select any mode to enter the game", 480, 250, arcade.color.WHITE, font_size=30, anchor_x="center")

            arcade.draw_text("K-2 Grades", 500, 400, arcade.color.WHITE, font_size=28, anchor_x="center")           
            arcade.draw_text("3-5 Grades", 500, 450, arcade.color.WHITE, font_size=28, anchor_x="center")           
            arcade.draw_text("6-8 Grades", 500, 500, arcade.color.WHITE, font_size=28, anchor_x="center")
            self.__init__()
            ...
            arcade.draw_text("Welcome to Wandering in the woods game", 630, 515, arcade.color.WHITE, font_size=18)
            arcade.draw_text(" player1 Score = " + str(self.player1Score), 690, 450,font_size=18)
            arcade.draw_text(" player2 Score = " + str(self.player2Score), 690, 400, font_size=18)
            ...
            if self.win == "player1":
                arcade.draw_text("Congratulations, Human has Won !", 100, 300, arcade.color.WHITE, font_size=35)
                arcade.draw_text("Click to continue", 480, 250, arcade.color.WHITE, font_size=30, anchor_x="center")
              

            elif self.win == "player2":
                arcade.draw_text("Congratulation player2 has Won :)", 100, 300, arcade.color.WHITE, font_size=35)
